...
if __name__ == '__main__': 
    ...
    feltlengde = pd.read_excel( '../resultater/revidertFeltlengde.xlsx')
    feltlengde = feltlengde[['Fylkesnummer2024', 'Feltlengde (km)']]
    feltlengde.rename( columns={'Fylkesnummer2024' : 'fylke' }, inplace=True )
    # brutusdata = pd.read_excel( '../resultater/bruer_ferjekaier.xlsx')
    vegnett    = pd.read_excel( '../resultater/veglengerFVJuni2023.xlsx')
    vegnett.drop( columns='Feltlengde (km)', inplace=True )
    ...
    staalbru   = pd.read_excel( '../resultater/staalbru.xlsx', sheet_name='Stålbru')
    ikkestaalbru   = pd.read_excel( '../resultater/staalbru.xlsx', sheet_name='Ikke stålbru')
    ...
    # myDfList = [ vegnett, brutusdata,  ]
    myDfList = [nyeFylker, vegnett, feltlengde, trafikk, rekkverk, lys, tunnel, staalbru, ikkestaalbru, ferjekai, sykkel,  fart50 ] # , brutusdata, sykkel, fart50, ferjekai ]
    ...
    nvdbgeotricks.skrivexcel( '../resultater/REVIDERTE Grunnlagsdata-inntekt-Fylkeskommunene2024.xlsx', FERDIG[columns])
